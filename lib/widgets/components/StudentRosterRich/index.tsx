    ...
    <div className="space-y-3">
      <div className="flex items-baseline justify-between flex-wrap gap-2">
        <div>
          ...
          {/* "N contacts disagree" pill removed (2026-07-01, Clint): the count
              was dominated by Parent-2 marketing contacts echoing student
              fields, not real data problems. The conflict CSV export endpoint
