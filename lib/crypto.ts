...
// Encrypt a PIT (or any short secret) with AES-256-GCM. Inverse of decrypt.
// Returns the three parts that get persisted into schools.ghl_pit_encrypted /
// ghl_pit_iv / ghl_pit_tag.
