...
export interface FinancialAidSettings {
  ...
  // Policy caps the AI applies AFTER its unrestricted recommendation.
  max_award_pct_of_tuition: number | null;          // 0.50 = 50% cap
  min_family_contribution_pct: number | null;       // 0.20 = family pays 20% floor
  policy_notes: string | null;
  // Regional cost-of-living context.
  regional_col_multiplier: number;                  // 1.0 = US avg
  regional_col_label: string | null;                // 'Phoenix metro — moderate COL'
}
